...
|---|---|---|---|
| PH-PROBE-01 | Threaded wet pH sensor and primary mechanical interface. | The exact BOQU PH8012 is confirmed by BOQU documentation and a manufacturer Alibaba listing advertising roughly US$50-76 before delivery. No current Taobao product page was confirmed. | **Exact model, external only.** Do not assume it is available on Taobao. The CNY 90 cap is probably too low for the exact model. Obtain a Taobao seller link and confirm the BNC/Q9, 3/4-inch NPT, cable, and complete-electrode variant. |
